...
const ArtikelIslami = () => {
  const [activeCategory, setActiveCategory] = useState("artikel-islami");
    ...
    >
      ...
      <div className="bg-white/10 min-h-screen pb-5">
        <div className="pt-4">
          ...
          <div className="grid grid-cols-5 lg:w-[80%] h-12 items-center overflow-hidden lg:mx-auto mx-2 mb-5 bg-gradient-to-r from-emerald-800 via-emerald-700 to-emerald-500 rounded-t-lg">
            {tabs.map((tab) => (
              <button
                key={tab.value}
