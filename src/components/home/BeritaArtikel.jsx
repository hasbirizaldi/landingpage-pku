...
const BeritaArtikel = () => {
  ...
  return (
    <section data-aos="fade-up" className="bg-white/60 py-10 lg:px-5 px-2 lg:w-[80%] lg:mx-auto mx-2 rounded sm:rounded-lg shadow-ku my-5">
      ...
      <h3 className="text-xl sm:text-xl font-semibold text-green-900 mb-4">Artikel Menarik</h3>
        ...
        {artikels.map((item) => (
          ...
          >
            ...
            <div className="p-3">
              ...
              {/* LINK */}
              <span
                className="absolute bottom-4 left-4 text-sm font-semibold text-blue-500 hover:text-blue-600 flex items-center"
              >
                Baca Selengkapnya
