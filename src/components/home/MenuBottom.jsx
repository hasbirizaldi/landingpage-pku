  ...
  return (
    <section className="lg:hidden fixed bottom-0 w-full z-60 border-t-2 border-white">
      <div className="grid grid-cols-3 lg:grid-cols-3 h-16 lg:rounded-b-2xl overflow-hidden">
        <Link to="/jadwal-dokter" className="flex flex-col items-center justify-center py-1 bg-green-800 group hover:bg-green-900 transition">
        ...
        <Link to="/" className="flex flex-col items-center justify-center py-1 bg-red-800 border-x-2 border-white group hover:bg-green-900 transition">
        ...
        <Link to="/" className="flex flex-col items-center justify-center py-1 bg-green-800 group hover:bg-green-900 transition">
          <div className="bg-white p-1 rounded-full group-hover:bg-green-700">
